...
//			String logoPath = "F:/186875.jpg";
			String logoPath = "F:/timg.jpg";
//			String logo_savePath = "F:/" + new Date().getTime() + ".png";
//			String str = toQRCode("http://wpa.qq.com/msgrd?v=3&uin=8078687", logoPath, logo_savePath,  "扫码联系我");			
			//String str = "F:/QQ图片20170921214520.png";		
			//System.out.println(decode(str));
			//System.out.println(Arrays.toString(Base64.decodeBase64(str)));
//			String logo_savePath = "F:/" + new Date().getTime() + ".png";
//			String str = toQRCode("https://u.wechat.com/EGhpSU2vT9GugB4ECk3Eom4", logoPath, logo_savePath,  "扫码加我");
//			System.out.println(decode(str));
			String logo_savePath = "D:/" + new Date().getTime() + ".png";
			String str = toQRCode("http://shang.qq.com/wpa/qunwpa?idkey=be90adac9dfb6d68d2405e08020900040b086dd2b87ce46fc069299bc0d3ecf6", logoPath, logo_savePath,  "欢迎加群交流");
			System.out.println(decode(str));
		} catch (Exception e) {
			e.printStackTrace();
		}
