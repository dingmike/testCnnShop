package com.platform.service.wxMsg.impl;
...
import com.platform.entity.base.WechatResult;
import com.platform.entity.wxMsg.media.MpVideoMedia;
import com.platform.entity.wxMsg.media.UploadMediasResult;
import com.platform.entity.wxMsg.req.BasicMsg;
import com.platform.entity.wxMsg.resp.MassMsgResult;
import com.platform.entity.wxMsg.resp.RespTextMsg;
import com.platform.entity.wxMsg.template.resp.TemplateMsgResult;
import com.platform.service.wxMsg.WechatMsgService;
...
public class WechatMsgServiceImpl implements WechatMsgService {
	...
	public MassMsgResult sendTextToTag(String accessToken, int tagId, String content){
		...
		String json = HttpReqUtil.HttpsDefaultExecute(SystemConstant.POST_METHOD, WechatConfig.SEND_ALL_MASS_MESSAGE_URL, params, data, null);
		try {
	...
	public MassMsgResult sendMpnewsToOpenid(String accessToken, List<String> openids, String mediaId){
		...
		String data = JsonUtil.toJsonString(dataParams);
		String json = HttpReqUtil.HttpsDefaultExecute(SystemConstant.POST_METHOD, WechatConfig.SEND_MASS_MESSAGE_URL, params, data, null);
		try {
			result = JsonUtil.fromJsonString(json, MassMsgResult.class);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void main(String[] args){
		...
		UploadMediasResult mediaResult = HttpReqUtil.uploadTempMediaFile(accessToken,"video",mediaPath, null);
		...
		UploadMediasResult result = HttpReqUtil.uploadMediaVideo(accessToken,m, null);
