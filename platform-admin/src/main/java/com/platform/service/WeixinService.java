...
//    config.setAppId(this.wxConfig.getAppid());
    config.setAppId(ResourceUtil.getConfigByName("wxmp.appid"));
    // 设置微信公众号的app corpSecret
//    config.setSecret(this.wxConfig.getAppSecret());
    config.setSecret(ResourceUtil.getConfigByName("wxmp.appsecret"));
    // 设置微信公众号的token
//    config.setToken(this.wxConfig.getToken());
    config.setToken(ResourceUtil.getConfigByName("wxmp.token"));
    // 设置消息加解密密钥
//    config.setAesKey(this.wxConfig.getAesKey());
    config.setAesKey(ResourceUtil.getConfigByName("wxmp.aeskey"));
